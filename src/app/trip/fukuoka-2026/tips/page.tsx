  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      ...
      >
        ...
        <Link
          href="/"
          className="absolute left-5 top-7 flex h-10 w-10 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.07] text-white backdrop-blur-sm transition-all hover:bg-white/15"
        >
          <ChevronLeft size={18} />
        </Link>
        ...
        <div className="animate-fade-up delay-100">
          <h1 className="font-playfair text-[40px] font-bold text-white mb-1 tracking-tight drop-shadow-lg">
            🧭 Escort
          </h1>
          <h1 className="font-playfair text-[40px] font-bold italic text-amber-300 tracking-tight drop-shadow-lg mb-4">
            Tips
          </h1>
        </div>
      ...
      <div className="-mt-10 relative z-10">
        <TipsSection tips={day1Tips} dayNumber={1} />
        <TipsSection tips={day2Tips} dayNumber={2} />
      </div>
      ...
      <section className="px-5 py-8">
        <div className="mb-5 flex items-center gap-3">
          ...
          <span className="text-[9px] font-black tracking-[5px] text-stone-400 uppercase">
            Final Checklist
          </span>
        ...
        <div
          className="rounded-[24px] p-6 ring-1 ring-amber-200/50"
          ...
          <ul className="space-y-4">
            {[
              ...
              >
                ...
                <span className="text-[13px] font-bold text-stone-700 tracking-tight flex-1">
                  {item.text}
                </span>
      ...
      {/* Footer note */}
      <footer className="mt-6 px-8 text-center pb-4">
        <div className="flex items-center gap-3 justify-center mb-3">
          <div className="h-px w-8 bg-linear-to-r from-transparent to-stone-200" />
          <span className="text-[9px] font-black tracking-[4px] text-stone-300 uppercase">
            Enjoy your special trip
          </span>
          <div className="h-px w-8 bg-linear-to-l from-transparent to-stone-200" />
        </div>
      </footer>
    </div>
  );
