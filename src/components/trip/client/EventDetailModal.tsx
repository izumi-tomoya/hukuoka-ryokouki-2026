      ...
      <Dialog.Portal>
        ...
        <Dialog.Popup className="fixed left-1/2 top-1/2 z-50 flex flex-col w-[94%] max-w-2xl max-h-[92vh] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-[32px] md:rounded-[40px] bg-white/97 shadow-2xl shadow-rose-300/20 backdrop-blur-xl ring-1 ring-rose-100/60 transition-all duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] focus:outline-none">
          ...
          >
            ...
            {isSurprise ? (
              <>
                <div className="absolute inset-0 bg-linear-to-br from-stone-900 via-stone-950 to-black opacity-90" />
                <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-amber-500/10 blur-[80px] animate-pulse" />
                <div
              ...
              <div className="absolute inset-0 bg-linear-to-br from-rose-300/30 to-transparent opacity-50" />
            ) : (
              <div className="absolute inset-0 bg-linear-to-br from-pink-200/20 to-transparent opacity-40" />
            )}
            ...
            <Dialog.Close className="absolute right-6 top-6 z-20 flex h-10 w-10 items-center justify-center rounded-full bg-white/25 text-white backdrop-blur-md ring-1 ring-white/30 transition-all hover:bg-white/40 hover:scale-110 active:scale-90">
              <X size={20} />
            </Dialog.Close>
          </div>
